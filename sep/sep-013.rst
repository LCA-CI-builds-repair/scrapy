...
Created  2009-11-14   spider)''' for consistency with the other middlewares
...
3. remove methods: ``open_spider``, ``close_spider``. They should be
   replaced by using the ``spider_opened``, ``spider_closed`` signals, butus   Document in progress (being written)
=======  ====================================
