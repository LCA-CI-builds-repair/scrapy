...
class MediaPipeline:
    ...
    def _cache_result_and_execute_waiters(self, result, fp, info):
        if isinstance(result, Failure):
            ...
            # When the media_downloaded callback raises an exception, like
            # FileException('download-error') for non-200 OK Response status code,
            # the original StopIteration exception (containing failed Response and Request)
            # is encapsulated within the FileException context.
            #
