...
class ExecutionEngine:
    def __init__(self, crawler: "Crawler", spider_closed_callback: Callable) -> None:
        ...
        downloader_cls: Type[Downloader] = load_object(crawler.settings['DOWNLOADER'])
        self.downloader = build_from_crawler(objcls=downloader_cls, crawler=crawler)(self.settings["DOWNLOADER"])
